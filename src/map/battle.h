...
// VIP Drop Boost - [GreenStage]
		int item_rate_card_boss_vip,item_rate_card_vip,item_rate_equip_vip,item_rate_equip_boss_vip,item_rate_use_vip,item_rate_use_boss_vip,
		item_rate_heal_vip,item_rate_heal_boss_vip,item_rate_common_vip,item_rate_common_boss_vip,gm_drop_boost;
// Versão 1.1 - VIP Exp Boost - [GreenStage]
        int base_exp_vip_boost,job_exp_vip_boost,gm_exp_boost; 
} battle_config;
