...
BUILDIN_FUNC(getmapflag)
{
	...
	if(m >= 0) {
		switch(i) {
			...
			case MF_BYPASS_NOSKILL:        script_pushint(st,map->list[m].flag.bypass_noskill); break;
		}
	}
...
BUILDIN_FUNC(setmapflag)
{
	...
	if(m >= 0) {
		switch(i) {
			...
			case MF_BYPASS_NOSKILL:     map->list[m].flag.bypass_noskill=1; break;
		}
	}
...
BUILDIN_FUNC(removemapflag)
{
	...
	if(m >= 0) {
		switch(i) {
			...
			case MF_BYPASS_NOSKILL:     map->list[m].flag.bypass_noskill=0; break;
		}
	}
